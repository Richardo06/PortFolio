...
<main class="main">
      ...
      <div class="container">
        <nav class="breadcrumbs">
          <ol>
            ...
            <li class="current">Details Ticket Management</li>
          </ol>
        </nav>
      </div>
    </div><!-- End Page Title -->
    ...
    <section id="about" class="about section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Details</h2>
        <p>A web-based ticket management application built with Laravel and MySQL, designed to centralize and streamline the handling of technical support requests within an organization.
        Users can submit detailed tickets, track their status (pending, in progress, resolved), and receive automated email notifications on updates.
        Administrators can assign tickets, leave internal notes, and access performance analytics through an interactive dashboard.
        This project was developed to improve support responsiveness and enhance traceability of interventions.</p>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4 justify-content-center">
          <div class="col-lg-4">
            <img src="assets/img/Tickets.PNG" class="img-fluid" alt="">
          </div>
          <div class="col-lg-8 content">
            <h2>Details Ticket Management.</h2>
            <h5>Technology</h5>
            <div class="row">
              <div class="col-lg-6">
                <ul>
              ...
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="bi bi-chevron-right"></i> <strong>Source GitHub</strong> <a href="https://github.com/Richardo06/GestionTicket">Tickets</a></li>
                </ul>
              </div>
            </div>
